...
txtpath=r"21data.txt"
txtpath_w_x=r"21data_x.txt"
txtpath_w_y=r"21data_y.txt"

fp=open(txtpath)
fp_write_x = open(txtpath_w_x,'w+')
fp_write_y = open(txtpath_w_y,'w+')
...
for lines in fp.readlines():
    ...
    if(lines[0][0]== '>'):
        ...
        RNA_sequence = lines
        mer_frequence(RNA_num, RNA_sequence[0])     
